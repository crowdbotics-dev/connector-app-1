"""
Django settings for connector_app_1 project.
...
ROOT_URLCONF = 'connector_app_1.urls'
...
WSGI_APPLICATION = 'connector_app_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "connector_app_1 API",
    "DESCRIPTION": "API documentation for connector_app_1 App",
    "VERSION": "v1",
}
